...
template<class T> 
T sum_scalar(VrArrayPtrF64 A) {
        PyObject *a = PyArray_Sum(A, NPY_MAXDIMS, PyArray_DESCR(A)->type_num, NULL);
        return (T)((PyDoubleScalarObject*)a)->obval;
} 
...
// VrArrayPtrCF64 zeros_double_complex(int,...);
// VrArrayPtrCF32 zeros_float_complex(int,...);
// VrArrayPtrF32 zeros_float(int,...);
// VrArrayPtrI32 zeros_int(int,...);
// VrArrayPtrF64 ones_double(int,...);
// VrArrayPtrF64 ones_long(int,...);
// VrArrayPtrF64 ones_float(int,...);
// VrArrayPtrF64 ones_int(int,...);
// VrArrayPtrF64 empty_double(int,...);
// VrArrayPtrCF64 empty_double_complex(int,...);
// VrArrayPtrF32 empty_float(int,...);
// VrArrayPtrCF32 empty_float_complex(int,...);
// VrArrayPtrI32 empty_int(int,...);
// VrArrayPtrI64 empty_long(int,...);
